$(document).ready(function () {
    ...
    $('#btnLuu').click(function () {
        ...
        $.ajax({
            ...
            data: { msv, ho_ten, sdt, ngay_sinh, dia_chi, image },
            dataType: "json",
            ...
            for (let sv of data) {
                body += `
                    <tr>
                        ...
                        <td>${sv.msv}</td>
                        <td>${sv.lop}</td>
                        <td><img src='${sv.image}' style="max-width:150px; height:auto;" alter='${sv.ho_ten}'/></td>
                        <td>
                            <div><a href='./chitiet.html?id=${sv.id}'}'><i class="fa fa-eye"></i>Xem chi tiết</a></div>
                            <div style='cursor:pointer; color:red;' onclick=deleteSinhVien(${sv.id})><i class="fa fa-trash"></i>Xóa</div>
                        </td>
                    </tr>
                `;
            }
